...
> **请带末尾斜杠 `/`**。  
> 镜像入口：https://itoulee.github.io/ember-hegemony/mirror.html  
> itch 打包说明：[docs/ITCH.md](docs/ITCH.md)

打开后应看到**剧本选单**；游戏中 **系统 → 返回剧本选单**。  
扩展说明：[docs/EXPANSION.md](docs/EXPANSION.md)
...
| **P2.1+** | 目标罗盘、胜利面板、成人内容包 |
| **P2.3** | 存档导出/导入、角色线 HE、CG、后宫 |
| **P2.4 A+B** | 角色线/势力链/成人/剧本/外交/自定义胜利/战棋/模组台 |
| **P2.5 C+D** | 教程气泡可跳过、移动端大按钮、镜像/itch 说明、Godot 存档+目标、程序立绘、事件对话窗、扩展音效 |
