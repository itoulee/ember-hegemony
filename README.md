...
> **请带末尾斜杠 `/`**。无斜杠时资源路径可能错，导致剧本列表空白。  
> 打开后应看到全屏**剧本选单**；若在游戏中可点 **系统 → 返回剧本选单**。

桌面/手机浏览器均可。扩展与 R18 分轨说明见 [docs/EXPANSION.md](docs/EXPANSION.md)。
...
| **P2.4 A+B** | 6 角色线、3 势力链、成人加深、新剧本、外交条、自定义胜利、战棋兵种/笔刷、模组工作台 |
